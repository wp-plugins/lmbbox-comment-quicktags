...
5. If you wish to change/edit the Quicktag Buttons that are displayed, you will need to edit 
	the lmbbox-comment-quicktags.php file. Open the file and find "// edit the buttons here" 
	on about line 141. Below you will see all of the buttons definded. To remove a button, 
	simple either remove the code for it, or comment out the code with "/* code_is_here */". 
...
=== End of LMB^Box Comment Quicktags 1.5 ===
