...
Version: 2.3 <img src="http://aboutme.lmbbox.com/plugins-updates.php?plugin=lmbbox-comment-quicktags&version=2.3" alt="Checking For Updates ..." title="Checking For Updates ..." />
Author: Thomas Montague
Author URI: http://aboutme.lmbbox.com
*/ 
/*
LMB^Box Comment Quicktags -> Was WP Comment Quicktags Plus!
version 2.3, 2006-01-26
By Thomas Montague
...
4. The code added at the lmbbox_comments_quicktags() function call has some CSS styling tags 
	...
	look. There is a span with a id of comment_quicktags that wraps the whole of the code. 
...
?>
		<!-- BEGIN - LMB^Box Comment Quicktags Display //-->
...
?>
		...
		<!-- END - LMB^Box Comment Quicktags Display //-->
<?php
			}
		}
...
<?php
	...
	function lmbbox_comment_quicktags_head() {
		if (is_single() || is_page()) {
?>
	<!-- BEGIN - LMB^Box Comment Quicktags Javascript //-->
	...
	<!-- END - LMB^Box Comment Quicktags Javascript //-->
<?php
		}
	}
	...
	function lmbbox_comment_quicktags_define_textfield() {	
		if ($GLOBALS['lmbbox_comment_quicktags']->options['display_comment_qucktags_toobar']) {
?>
	<!-- BEGIN - LMB^Box Comment Quicktags Javascript //-->
	<script type="text/javascript" language="javascript">
	<!--
...
<?php
	...
	function lmbbox_comment_quicktags_add_options_page() {
		// add_options_page Function Call Back
		function lmbbox_comment_quicktags_options_page() { $GLOBALS['lmbbox_comment_quicktags']->options_page(); }
		add_options_page('LMB^Box Comment Quicktags', 'LMB^Box Comment Quicktags', $GLOBALS['lmbbox_comment_quicktags']->options['min_user_level'], 'lmbbox-comment-quicktags.php', 'lmbbox_comment_quicktags_options_page');
	}
	...
	add_action('admin_menu', 'lmbbox_comment_quicktags_add_options_page');
	add_action('wp_head', 'lmbbox_comment_quicktags_head');
