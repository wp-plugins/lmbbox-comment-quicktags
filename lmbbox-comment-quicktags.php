...
?>
	...
	<script type="text/javascript" language="javascript" src="<?php echo get_settings('home'); ?>/wp-content/plugins/lmbbox-comment-quicktags.php"></script>
...
<?php
	...
	function lmbbox_comment_quicktags_define_textfield() {	
		...
		if ($lmbbox_comment_quicktags->options['display_comment_qucktags_toobar']) {
?>
	<!-- BEGIN - LMB^Box Comment Quicktags Javascript //-->
	<script type="text/javascript" language="javascript">
	<!--
